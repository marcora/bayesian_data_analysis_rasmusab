...
# probability distribution = table of probabilities of events (i.e., set of outcomes) corresponding to each possible value returned by the random variable when applied to each outcome in the sample space
