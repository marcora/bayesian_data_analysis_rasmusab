...
$$
P(W \mid N,p) = \text{Binomial}(W \mid N,p)
$$

\[Prior distribution\]

$$
P(p) = \text{Uniform}(p \mid 0,1)
$$

Bayesian estimator (posterior distribution = data distribution x prior distribution):

$$
P(p \mid W,N) \propto P(W \mid N,p) \times P(p) \\
P(p \mid W,N) \propto \text{Binomial}(W \mid N,p) \times \text{Uniform}(p \mid 0,1)
$$
