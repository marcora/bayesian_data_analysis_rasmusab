...
$$
P(\theta \mid X, M) = \frac{P(\theta \mid M) P(X \mid \theta, M)}{P(X \mid M)}
$$
...
$$
P(W = 3,L = 6 \mid \pi) =  \text{Binomial}(W = 3, L = 6, \pi) = \frac{(W+L)!}{W!L!} \pi^W (1 - \pi)^L = \frac{(3+6)!}{3!6!} \pi^3 (1 - \pi)^6 = \frac{362880}{4320} \pi^3 (1 - \pi)^6
$$

\[Prior distribution\]

$$
P(\pi \mid a=0,b=1) = \text{Uniform}(\pi, a=0, b=1) = \frac{1}{b - a} = 1
$$
...
$$
P(\pi \mid W = 3, L = 6) \propto \frac{362880}{4320} \pi^3 (1 - \pi)^6 \times 1
$$
