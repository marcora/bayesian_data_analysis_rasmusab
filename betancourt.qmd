...
\[n.b.: this assumption breaks if, for example, there is "selection bias"\]
...
For example, in the case of a normal likelihood:
...
In the case of linear regression $f$ is additive:
