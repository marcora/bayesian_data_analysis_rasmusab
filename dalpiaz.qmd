...
-   <https://youtube.com/playlist?list=PLBgxzZMu3GpMP9t8gz6AGGoxcBgWBKaVq>

Statistics = learning from experience (data and prior knowledge)

## Machine learning

-   Machine learning
    -   Supervised (tabular data with output \[variate/response/outcome/dependent\] variable $Y$ and input variables \[covariates/treatment/predictors/features/independent\|explanatory variables\] $X_1, X_2, \ldots, X_p$)
        -   Regression (numerical response variable)
        -   Classification (categorical response variable)
    -   Unsupervised (tabular data without output variable $Y$, only input variables $X_1, X_2, \ldots, X_p$)
        -   Density estimation
        -   Outlier detection
        -   Clustering
