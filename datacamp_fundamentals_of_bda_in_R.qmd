...
-   Finally, calculate the probability that proportion of success is larger for drug A (video ad) than for drug B (text ad). That is, calculate the proportion of samples in `posterior$prop_diff` that are more than zero.
