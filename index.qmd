...
Data story \> Data generation process \> Generative model (function that takes parameters and returns data/observations/sample).
...
d %>% ggplot(aes(x = x, y = y, color = factor(x))) +
  ...
  geom_abline(intercept = beta0, slope = beta1, linetype = "dotted") +
  theme_bw()
```
