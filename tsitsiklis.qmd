...
For example, probability $P$ is a function ("probability law") that assigns a real number $\mathbb{R}$ to each element $E$ of the event space $\Sigma$ (i.e., each subset of the sample space $\Omega$):
...
for mutually exclusive events/disjoint sets $E_1, E_2, \ldots$
