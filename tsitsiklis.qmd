...
A function is a rule that maps each element of set $A$ to at least one element of set $B$.

$$
f : A \rightarrow B
$$

More precisely, a function is a set of pairs $(x, y)$ such that $x \in A$, $y \in B$ and each $x$ appears in exactly one pair.
