...
-   A random variable often describes a measurable quantity associated with the outcome of random experiment or it indicates whether a specific event has occurred (e.g., $x = 1$ if $s_1 \in A$ or $x = 0$ if $s_1 \notin A$).
