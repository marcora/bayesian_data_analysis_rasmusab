...
-   Analytics deals with what we know, the facts/information we have (data)

-   Statistics (statistical inference) deals with what we don't know, the facts/information we wish we had (quaesita)
...
-   The sample is the facts/information we have (data) and the population is the facts/information we wish we had (quaesita)

-   Observation: A measurement of a (property of a) single item in a sample

## What is a statistic/parameter?

-   Statistic: A summary measure computed from a sample, i.e., any way of mushing up the facts/information we have (data, boring!)\
    ![](trees_4.webp){width="569"}

-   Parameter: A summary measure of a population, i.e., any way of mushing up the facts/information we don't have (quaesita, interesting!)\
...
-   If you have all the facts/information about the population of interest you know its parameters with certainty (analytics)

-   If you don't have all the facts/information about the population of interest, you can't know its parameters with certainty (statistics)
...
-   The intuitive best guess (that comes from treating the sample as if it was the population) is pretty good (most of the time)
    ...
    6.  Why do we need statistical inference? Why not just use the intuitive best guess? Because it may be wrong and the only way to know if it is right or wrong is if you had certainty, i.e., you have the facts/information about all things/items/objects in the population of interest!
    ...
    12. When we don't have all the facts, all we can hope for is combining the facts/information we have with assumptions to *make reasonable decisions*.
